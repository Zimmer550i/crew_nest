...
class LandlordBooking extends StatefulWidget {
  const LandlordBooking({super.key});

  @override
  State<LandlordBooking> createState() => _LandlordBookingState();
}

class _LandlordBookingState extends State<LandlordBooking> {
  int index = 0;
        ...
        children: [
          ...
          Expanded(
            child: CustomListHandler(
              children: [for (int i = 0; i < 10; i++) LandlordBookingCard()],
            ),
          ),
        ],
      ),
